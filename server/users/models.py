...
class User(Document):
    ...
    last_login = fields.DateTimeField(default=datetime.datetime.now(), verbose_name=_('last login'))
    date_joined = fields.DateTimeField(default=datetime.datetime.now(), verbose_name=_('date joined'))
    ...
    @classmethod
    def create_user(cls, id, username, name, password, is_superuser=False, is_active=True, is_staff=False):
        """
        ...
        user = cls(id=id, username=username, name=name, date_joined=now, is_superuser=is_superuser, is_active=is_active, is_staff=is_staff)

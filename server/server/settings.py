...
# We define 2 Mongo databases - producao and homologacao
# if you use timezones in django (USE_TZ = True)
...
CLIENT = mongoengine.connect(
    alias='default',
    db=MONGODB_DATABASES[SERVER]['name'],
    host=MONGODB_DATABASES[SERVER]['host']
)
